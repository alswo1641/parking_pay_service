...
class MainAbility extends StatefulWidget {
  const MainAbility({super.key});

  @override
  _MainAbilityState createState() => _MainAbilityState();
}

class _MainAbilityState extends State<MainAbility> {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Padding(
        ...
        child: ElevatedButton(
          onPressed: () {
            Navigator.pushNamed(context, '/nextoo');
          },
          child: Text(
            '다음',
            style: TextStyle(
